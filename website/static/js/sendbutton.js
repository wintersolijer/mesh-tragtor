$(document).ready(function() {
    $('#sendMsgButton').click(function(event) {
        ...
        // question to the div 
        chatelement = `<div class="user_question_div"><h3 class="messager_name_head">You</h3> <p>${inputData}</p></div>`
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                chat_element = `<div class="llm_response_div"><h3 class="messager_name_head">TruManual.ai</h3> <p>${response['llm_response']}<p><br><br><a href="${link_text}">Click here for more information</a></div>`
